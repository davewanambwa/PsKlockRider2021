...
catch (Exception e)
{
    id=0;
            ...
            {
                Toast.makeText(forgot.this, "Email not registered.",Toast.LENGTH_LONG).show();
            }
        ...
        public void whenSendPostRequest_thenCorrect()
            ...
            String url="https://corellia.co.ke/rider/two.php?action=driverresetpasswordreq&email="+email;
